...
function SubmissionEditor({studentId, assignment, readOnly, onClose, focusWorksheetId}){
  ...
  return (
    <div style={{...CARD, padding:"24px 22px"}}>
      ...
      {/* Session 18C v6: at-a-glance review chip grid for the locked
          submission. Same component used in the tutor's review panel,
          rendered here so the student can quickly scan which questions
          they got right/wrong + their flags without scrolling the full
          editor. Only renders when graded data is available. */}
      {isLocked && submission && Array.isArray(submission.perQuestion) && submission.perQuestion.length > 0 && (
